 ...
 * LICENSE file in the root directory of this source tree.
 */
var l=__webpack_require__(418),m=__webpack_require__(294);function p(a){for(var b="https://reactjs.org/docs/error-decoder.html?invariant="+a,c=1;c<arguments.length;c++)b+="&args[]="+encodeURIComponent(arguments[c]);return"Minified React error #"+a+"; visit "+b+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}
...
var server_browser = __webpack_require__(762);
...
/* harmony default export */ const slideLayout_SlideLayout = (SlideLayout);
...
;// CONCATENATED MODULE: ./src/components/emoji/Emoji.js
...
Emoji.propTypes = {
  className: (prop_types_default()).string,
  symbol: (prop_types_default()).string
};
Emoji.defaultProps = {
  className: '',
  symbol: ''
...
UserCard.propTypes = {
  ...
  showDetails: (prop_types_default()).bool,
  size: prop_types_default().oneOf([userCardSizes.m, userCardSizes.s]),
  'data-action': (prop_types_default()).string,
  'data-params': (prop_types_default()).string
};
...
var PrizePodiumColumn = function PrizePodiumColumn(props) {
  ...
  return /*#__PURE__*/react.createElement("div", {
    ...
    className: "prize-podium-column__place"
  }, place));
};

PrizePodiumColumn.propTypes = {
  place: (prop_types_default()).number,
  isWinner: (prop_types_default()).bool
};
...
/* harmony default export */ const leaders_LeadersSlide = (LeadersSlide);
;// CONCATENATED MODULE: ./src/components/arrowButton/ArrowButton.js
...
/* harmony default export */ const vote_VoteSlide = (VoteSlide);
;// CONCATENATED MODULE: ./src/components/bar/Bar.js
...
/* harmony default export */ const chart_ChartSlide = (ChartSlide);
;// CONCATENATED MODULE: ./src/components/commitsCategory/CommitsCategory.js
...
var CommitsCategory = function CommitsCategory(props) {
  ...
  return /*#__PURE__*/react.createElement("div", {
    ...
    className: "commits-category__stats"
  }, /*#__PURE__*/react.createElement("span", {
    className: "commits-category__diff"
  }, diff), /*#__PURE__*/react.createElement("span", {
    className: "commits-category__value"
  }, value)));
};

CommitsCategory.propTypes = {
  className: (prop_types_default()).string,
  type: prop_types_default().oneOf([sprintCommitsCategory.s, sprintCommitsCategory.m, sprintCommitsCategory.l, sprintCommitsCategory.xl]),
  title: (prop_types_default()).string,
  value: (prop_types_default()).string,
  diff: (prop_types_default()).string
};
CommitsCategory.defaultProps = {
  className: '',
  type: sprintCommitsCategory.s,
  title: '',
  value: '',
  diff: ''
};
/* harmony default export */ const commitsCategory_CommitsCategory = (CommitsCategory);
;// CONCATENATED MODULE: ./src/slides/diagram/Diagram.js
...
Diagram.propTypes = {
  title: (prop_types_default()).string,
  subtitle: (prop_types_default()).string,
  totalText: (prop_types_default()).string,
  differenceText: (prop_types_default()).string,
